...
/* for (let index = 1; index <= 50; index++){
 ...
 mostrar solo los nombres de los Pokémons cuyos números que son múltiplos de 5 desde 1 hasta el 
 número introducido por el usuario. https://pastebin.com/Zzk8g7Z6. */
...
const numero = parseInt(prompt("Por favor digite un numero"));
